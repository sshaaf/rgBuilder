...
mod tests {
    use super::*;
    use rgbuilder_plugin_api::{ConfigValueType, SourceLocation, SymbolType};
    ...
    fn add_symbol_with_body_sets_token_bloom() {
        ...
        assert!(rgbuilder_graph::keyword_in_bloom("ntohs", &bloom));
    }
    ...
    fn test_add_symbol_materializes_fields() {
        ...
        symbol.fields = vec![rgbuilder_plugin_api::Field {
