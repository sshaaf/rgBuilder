...
pub fn export_cfg_slice_from_storage(
    ...
    let analysis_dir = repo_root.join(".rgbuilder/analysis");
...
mod tests {
    use super::*;
    use rgbuilder_analysis::cfg_builder::build_cfg_for_function;
