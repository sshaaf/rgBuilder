...
fn walk_block(node: Node<'_>, ctx: &mut ExtractCtx<'_>) -> rgbuilder_plugin_api::Result<()> {
    match node.kind() {
...
fn extract_heading(node: Node<'_>, ctx: &mut ExtractCtx<'_>) -> rgbuilder_plugin_api::Result<()> {
