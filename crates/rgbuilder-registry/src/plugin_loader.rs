//! External plugin registry (`.rgbuilder/plugins.json`).
//!
...
/// Plugin registry persisted under `.rgbuilder/`.
...
impl PluginRegistry {
    ...
    pub fn save(&self, repo_root: &Path) -> Result<()> {
        let dir = repo_root.join(rgbuilder_graph::code_graph::GRAPH_DIR);
...
impl PluginLoader {
    ...
    /// Copy plugin into `.rgbuilder/plugins/` directory.
