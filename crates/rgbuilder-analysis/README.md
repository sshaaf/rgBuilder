...
Semantic search is **opt-in** (`rgbuilder semantic index`). Prefer `--embedder vocab` when building without ONNX. Profile queries with `--release`; see [semantic-search-design.md](../../docs/design/semantic-search-design.md).
