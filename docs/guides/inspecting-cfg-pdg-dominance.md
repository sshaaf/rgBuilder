...
```bash
rg-build -r example/coolstore-weblogic -f json inspect priceShoppingCart pdg
```
...
```bash
rg-build -r example/coolstore-weblogic -f json inspect priceShoppingCart dom
```
...
```bash
rg-build -r example/coolstore-weblogic -f json inspect priceShoppingCart dom --frontiers
```
...
```bash
rg-build -r example/coolstore-weblogic -f json inspect priceShoppingCart cfg --prune
```
...
```bash
rg-build -r example/coolstore-weblogic -f json inspect priceShoppingCart pdg --def-use
```
