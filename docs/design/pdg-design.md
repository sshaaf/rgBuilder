...
rgbuilder inspect process pdg --edge-layer data
rgbuilder inspect process pdg --def-use
rgbuilder -f mermaid inspect process pdg
rgbuilder slice src/Foo.java --line 42 --variable x --view pdg
```
