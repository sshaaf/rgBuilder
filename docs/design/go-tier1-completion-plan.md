...
**Issue:** https://github.com/sshaaf/rBuilder/issues/46
...
| 0.2 Fixture package | `rbuilder-tests/ecommerce-go/internal/langfeatures/` | Compiles; discover indexes symbols |
...
| 1.4 | Unit tests in `rbuilder-lang-go` for selector + collision | Prevents silent regression |
