...
- Commands and flags below match `rgbuilder --help` / subcommand help (as of this repo).
...
```
 ...
 └──────────┬────────────┘
            ...
            ▼
 ┌───────────────────────┐
 │ 2. AGENT TOOL CALL    │  tool_use: rgbuilder(command="-f json semantic query 'checkout flow'")
 └──────────┬────────────┘
            │
            ▼
 ┌───────────────────────┐
 ...
 └──────────┬────────────┘
            ...
            ▼
 ┌───────────────────────┐
 │ 5. CODE EDIT / ACTION │  Applies refactored code & verifies with rgbuilder(check)
 └───────────────────────┘
